            ...
            <div className="flex-grow">
                <div className="flex h-full items-center justify-center bg-gray-100 text-black">
                    <div className="w-1/2 p-12">
                        ...
                        <Link to="/spaces" class="text-semibold cursor-pointer mx-2 transition-all bg-blue-500 text-white px-6 py-4 rounded-lg border-blue-600 border-b-[4px] hover:brightness-110 hover:-translate-y-[1px] hover:border-b-[6px] active:border-b-[2px] active:brightness-90 active:translate-y-[2px] text-lg">
                            Discover Spaces
                        </Link>
                    </div>
