    ...
    return (
        <>
            <main className="flex flex-col h-screen relative bg-purple-50">
                <div className="absolute inset-44 container mx-auto border-2 bg-white w-1/4 h-1/2 rounded-lg shadow-xl">
                    <div className="flex flex-col justify-center items-center">
                        <h1 className="text-center text-2xl font-bold p-3 pb-1 mb-1">Login</h1>
                        ...
                        <div className="">
                            <p className="">Dont have an account? <Link to="/signup" className=""><strong>Signup</strong></Link></p>
                        </div>
